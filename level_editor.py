...
insta_img = pygame.image.load('instagram enemy.png')
football_img=pygame.image.load('football.png')
mobile_img=pygame.image.load('Mobile.png')
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 3:
					#enemy blocks
					img = pygame.transform.scale(football_img, (tile_size, int(tile_size * 0.75)))
				...
				if world_data[row][col] == 6:
					#insta enemy
					img = pygame.transform.scale(insta_img, (tile_size, int(tile_size * 0.75)))
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size * 0.25)))

				if world_data[row][col] == 7:
					img = pygame.transform.scale(mobile_img, (tile_size, int(tile_size * 0.75)))
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size * 0.25)))
